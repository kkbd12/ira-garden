    ...
    if (!ADMIN_PASSWORD) {
        return (
            <div className="flex justify-center items-center py-12">
                 <Card className="w-full max-w-md p-8 text-center bg-red-50 text-red-700">
                    <h2 className="text-xl font-bold mb-2">কনফিগারেশন ত্রুটি</h2>
                    <p>অ্যাডমিন পাসওয়ার্ড সেট করা নেই।</p>
                    <p className="text-sm mt-2 text-gray-600">অনুগ্রহ করে আপনার `.env.local` ফাইলে `VITE_ADMIN_PASSWORD` ভেরিয়েবল যোগ করুন।</p>
                 </Card>
            </div>
        )
    }
