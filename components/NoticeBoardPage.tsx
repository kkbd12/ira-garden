              ...
              <Card className="mb-8 p-4">
                <div className="flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-800 rounded-md font-semibold hover:bg-gray-200 transition-colors duration-300 text-sm"
